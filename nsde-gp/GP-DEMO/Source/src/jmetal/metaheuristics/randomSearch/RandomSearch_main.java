...
public class RandomSearch_main {
  ...
  public static void main(String [] args) throws
    ...
    if (args.length == 1) {
      ...
      problem = new Kursawe("Real", 3);     //The second parameter specifies the vector length (x1, x2,...xN)
    ...
    algorithm = new RandomSearch(problem);      // constructor in class RandomSearch, using super(problem) because extending class Algorithm
