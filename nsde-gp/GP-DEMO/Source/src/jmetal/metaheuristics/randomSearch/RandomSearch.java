...
public class RandomSearch extends Algorithm {
  ...
  */
   ...
   */
  public RandomSearch(Problem problem, Properties properties){
  ...
  */
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    for (int i = 0; i < maxEvaluations; i++) {
      newSolution = new Solution(problem_);     //Tukaj dobimo naključne spremenljivke
      problem_.evaluate(newSolution);
      problem_.evaluateConstraints(newSolution);
      evaluations++;
      ndl.add(newSolution);
      allSolutions.addToAll(newSolution);
    } //for
