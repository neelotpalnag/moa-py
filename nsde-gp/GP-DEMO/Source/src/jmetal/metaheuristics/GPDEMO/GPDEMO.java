 ...
 * T. Tusar. ....
 */
public class GPDEMO extends Algorithm{
  ...
  */
  public GPDEMO(Problem problem, Model globalModel) {
  ...
  * @param model Model used for estimation
  */
  public GPDEMO(Problem problem, Model globalModel, Model localModel) {
    super (problem);
   ...
   */
   public GPDEMO(Problem problem, Model globalModel, Properties properties) {
  ...
  * @param properties Properties of the algorithm
  */
  public GPDEMO(Problem problem, Model globalModel, Model localModel, Properties properties) {
...
double distance = 0;
  ...
  public SolutionSet environmentalSelectionNSGAIIWithUncertanty(SolutionSet population) throws JMException, ClassNotFoundException{
    ...
    Distance distance;
    RankingUnderUncertanty ranking;
    ...
    ranking = new RankingUnderUncertanty(population, problem_, setOfExactlyEvaluatedSolutions);
