 ...
 *   ...
 */
public class DemoUncertaintyCompare_main {
  ...
  *      - jmetal.metaheuristics.demo.demo_main problemName modelName
  *      - jmetal.metaheuristics.demo.demo_main problemName modelName paretoFrontFile
  */
  public static void main(String [] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
    ...
    algorithm = new DemoUncertaintyCompare(problem, model);
