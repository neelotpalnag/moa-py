...
public class XReal {
	...
	public double getValue(int index) throws JMException {
		if ((type_.getClass() == RealSolutionType.class) || (type_.getClass().equals(DiscreteSolutionType.class)) ||
	...
	public void setValue(int index, double value) throws JMException {
		if (type_.getClass() == RealSolutionType.class  || type_.getClass() == DiscreteSolutionType.class)
	 ...
	 */
	public int size() {
		if ((type_.getClass().equals(RealSolutionType.class)) || (type_.getClass().equals(DiscreteSolutionType.class)) ||
