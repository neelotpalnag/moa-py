 ...
 */
public class RankingUnderUncertanty {
   ...
   * @throws JMException 
   */       
  public RankingUnderUncertanty(SolutionSet population, Problem problem_, SolutionSet setOfExactlyEvaluatedSolutions) throws JMException {        
    ...
    // of individuals that dominate me
      ...
      if(p != q)
      	{
	        ...
	        /*else if (flagDominate == -2)   //evaluate p to see the dominance relation
	        {
	        	
	        }
	        
	        else if (flagDominate == 2)
	        {
	        	
	        }
	        
	        else if (flagDominate == -10)
	        {
      ...
      if(dominateMe[p] == 0 && population.get(p).isExactllyEvaluated() == false && reevaluateSolutionAgain == true)
      {
        ...
        setOfExactlyEvaluatedSolutions.add(population.get(p));
      	p = -1;
      }
    }
