 ...
 */
public class DominanceComparatorUnderUncertanty implements Comparator{
  ...
  */
  public int compare(Object object1, Object object2) {
    ...
    if(dominate1 > 0 && dominate2 == 0)
    {
  	  ...
  	  {
  	  	if (solution1.getSolutionFeasibility() == 0)
  	  	{
  	  		//System.out.println("Še en izraèun zaradi negotove fisibility"); 
  	  		if(solution1.isExactllyEvaluated() == false)
  	  			return -2;
  	  		else
  	  		{
  	  			//System.out.println("èuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuudo");
  	  			return -1;
  	  		}
  	  	}
  	  	else
    ...
    if(dominate1 == 0 && dominate2 > 0)
    {
  	  ...
  	  {
  	  	if (solution2.getSolutionFeasibility() == 0)  	  
  	  	{
  	  		//System.out.println("Še en izraèun zaradi negotove fisibility");
    ...
    else		//(dominate1 == 0 && dominate2 == 0)
    {
  		...
  		else	if (solution1.isExactllyEvaluated() == true)//because of variance we dont know which solution is better, we calculate one and compare again
  			return 2;
  		else	if (solution2.isExactllyEvaluated() == true)//because of variance we dont know which solution is better, we calculate one and compare again
  			return -2;
  		else	//because of variance we dont know which solution is better, we calculate one and compare again
  		{
  			if (solution1.getSolutionFeasibility() == 0)
  			{
  				//System.out.println("Prvi uncertainty");
  				return -2;  				
  			}
  			else if (solution2.getSolutionFeasibility() == 0)
  			{
  				//System.out.println("Drugi uncertainty");
  				return 2;  				
  			}
  			else
  				return -2;
