...
public abstract class Problem implements Serializable {
  ...
  /** 
   * Stores the number of features of the problem
   */
  protected int numberOfFeatures_ ;
  ...
  /** 
   * Gets the the number of features of the problem.
  ...
  /** 
   * Sets the the number of features of the problem.
   */
  ...
  /**
   * Evaluates a approximate value of a <code>Solution</code> object.
   * @param solution The <code>Solution</code> to evaluate.
   */    
  public void evaluateApproximateValue(Solution solution) throws JMException {	 
  }
   ...
   * @param solution The <code>Solution</code> to evaluate.
   */ 
  public void evaluateApproximateValue(Object tableOfNeuralNetworks, Solution child) throws JMException{
  }
