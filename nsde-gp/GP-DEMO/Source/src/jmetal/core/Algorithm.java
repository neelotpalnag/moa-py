...
public abstract class Algorithm implements Serializable {
  ...
  * evaluations.
  */
  protected Properties input_ = null;
  ...
  public Algorithm(Problem problem, Properties properties){
        problem_ = problem ;
        input_ = properties;
  }
  ...
  * the method is invoked by a Main object before running an algorithm. 
  * The parameters have to been inserted using their name to access them through 
  * the <code>getParameter</code> method.
  * @param name The parameter name
  * @param object Object that represent a parameter for the
  * algorithm.
  */
  public void setParameter(String name, Object object){
    if (input_ == null) {
      input_ = new Properties();
    }        
    input_.put(name,object);
  } // setParameter 
  ...
  */
  public String getParameter(String name){
      return input_.getProperty(name);
  } //getParameter
