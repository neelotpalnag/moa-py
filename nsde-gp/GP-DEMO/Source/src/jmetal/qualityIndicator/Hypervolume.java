...
public class Hypervolume {
  ...
  */
  ...
  public static void main(String args[]) {
  	...
  	double[][] solutionFront=new double[3][2];
  	solutionFront[0][0]=1.0;
  	solutionFront[0][1]=1.0;
  	solutionFront[1][0]=9.0;
  	solutionFront[1][1]=1.0;
  	solutionFront[2][0]=1.0;
  	solutionFront[2][1]=4.0;
  	
  	
  	
  	double[][] trueFront=new double[2][2];
  	trueFront[0][0]=10.0;
  	trueFront[0][1]=0.0;
  	trueFront[1][0]=0.0;
  	trueFront[1][1]=20.0;
