...
/**
 * Class representing problem Oyczka
 */
public class Osyczka extends Problem{
 /**
  * Constructor.
  * Creates a default instance of the Osyczka2 problem.
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public Osyczka(String solutionType) throws ClassNotFoundException {
    numberOfVariables_  = 6;
    numberOfObjectives_ = 2;
    numberOfConstraints_= 6;
    problemName_        = "Osyczka";
